    ...
    return (
        <article className="w-[400px] flex flex-col items-center rounded shadow-2xl">
            ...
            <section className="w-full">
                {tools.map((tool, i) => (
                    <a key={i} href={tool.link} target="_blank" className="flex p-8 border border-kryptokurz-gray border-t-0">
                        <img className="w-12 h-12 mr-5 object-cover" src={tool.img} />
